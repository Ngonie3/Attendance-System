...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "facerecognitionattendanc-8035e.appspot.com"
})
...
file.close()
encodeKnownListOfFaces, studentIds = encodedListWithIds
...
while True:
    ...
    if faceCurrFrame:
        for encodedFace, faceLocation in zip(encodeCurrFrame, faceCurrFrame):
            matches = face_recognition.compare_faces(encodeKnownListOfFaces, encodedFace)
            faceDistance = face_recognition.face_distance(encodeKnownListOfFaces, encodedFace)
